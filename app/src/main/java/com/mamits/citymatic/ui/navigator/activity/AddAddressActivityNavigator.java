...
public interface AddAddressActivityNavigator extends BaseNavigator {
    void showLoader();
    ...
    void onSuccessAddressAdded(JsonObject jsonObject);

    void onSuccessAddressUpdated(JsonObject jsonObject);

    void onSuccessGetAddress(JsonObject jsonObject);
}
