...
import com.mamits.citymatic.databinding.ActivityUpdateAddressBinding;
...
public class UpdateAddressActivity extends BaseActivity<ActivityUpdateAddressBinding, AddAddressViewModel> implements AddAddressActivityNavigator, View.OnClickListener {
    ...
    protected void init(Bundle savedInstanceState) {
        ...
        new ClickShrinkEffect(binding.btnUpdate);
        ...
        if (binding.getLocationFetch()) {
            requestLocationPermission();
        } else {
            if (id != -1) {
                mViewModel.fetchAddress(this, id);
            }
        }
    }
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.btn_update) {
            ...
            updateAddress(house_flat, landmark, address1, address2, address_type, pincode, this.id);
    ...
    private void updateAddress(String house_flat, String landmark, String address1, String address2, String address_type, String pincode, int id) {
        ...
        mViewModel.updateAddress(this, jsonObject.toString());
    }
    ...
    public void onSuccessGetAddress(JsonObject jsonObject) {
        if (jsonObject.get("status").getAsBoolean()) {
            AddressDataModel address = mGson.fromJson(jsonObject.get("data").getAsJsonObject().get("address").getAsJsonObject().toString(), AddressDataModel.class);
