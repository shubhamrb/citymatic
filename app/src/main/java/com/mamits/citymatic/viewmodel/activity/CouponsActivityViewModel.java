...
public class CouponsActivityViewModel extends BaseViewModel<CouponsActivityNavigator> {

    public CouponsActivityViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider) {
