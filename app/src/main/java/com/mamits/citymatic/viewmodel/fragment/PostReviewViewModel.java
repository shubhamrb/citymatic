...
public class PostReviewViewModel extends BaseViewModel<PostReviewNavigator> {

    public PostReviewViewModel(IDataManager dataManager, ISchedulerProvider schedulerProvider) {
        super(dataManager, schedulerProvider);
    }

    public void fetchOrders(Activity mActivity, JSONObject jsonObject) {
