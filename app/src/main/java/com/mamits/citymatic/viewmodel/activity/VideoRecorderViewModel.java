...
public class VideoRecorderViewModel extends BaseViewModel<VideoRecorderNavigator> {


    public VideoRecorderViewModel(IDataManager mDataManager, ISchedulerProvider mSchedulerProvider) {
