...
public class AddressModule {
    ...
    @Provides
    public AddressViewModel providesAddressViewModel(IDataManager mDataManger, ISchedulerProvider mSchedulerProvider) {
        return new AddressViewModel(mDataManger, mSchedulerProvider);
    }
